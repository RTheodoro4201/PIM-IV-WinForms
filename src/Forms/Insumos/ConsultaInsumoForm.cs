...
public partial class ConsultaInsumoForm : Form
{
    private readonly InsumoController _insumoController;
    private readonly int _idInsumo;

    public ConsultaInsumoForm(InsumoController insumoController, int idInsumo)
    {
        InitializeComponent();
    ...
    private async void ConsultaInsumoForm_Load(object sender, EventArgs e)
    {
